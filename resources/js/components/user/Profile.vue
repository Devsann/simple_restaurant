            ...
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header bg-black" style="background: url('./img/user-cover.jpg') center center;">
                        ...
                        <div class="widget-user-image user_img">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">Name</label>
                                        <div class="col-sm-12">
                                        <input type="" class="form-control" id="inputName" v-model="form.name" :class="{ 'is-invalid': form.errors.has('name') }">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="" class="form-control" id="inputEmail" v-model="form.email" :class="{ 'is-invalid': form.errors.has('email') }">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" id="inputExperience" v-model="form.bio" 
